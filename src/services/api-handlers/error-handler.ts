import { ResolverApiFailure } from './api-resolver';
...
class ErrorHandler {
    ...
    public handle442Error = (
        result: ResolverApiFailure,
        callback?: () => void,
    ) => {
